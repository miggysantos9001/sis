    ...
    <div class="col-md-12">
        <div class="block block-themed">
            <div class="block-header bg-primary">
                <h3 class="block-title">{{ __('msg.Daily Category Product Sales Report') }}</h3>
            </div>
            <div class="block-content block-content-full">
                {!! Form::open(['method'=>'POST','action'=>'SalesController@post_daily_category_product_sales']) !!}
                <div class="row">
                	<div class="col-md-6">
                		<div class="form-group">
                            {!! Form::label( __('msg.Select Category')) !!}
